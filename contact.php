            ...
            <div class="col-lg-8 col-md-9 col-sm-9 col-xs-12">
                <form action="contact" method="POST">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            <label for="cQuestion">Write your question</label>
                            <textarea class="form-control" name="cQuestion" id="cQuestion" placeholder="What's the meaning of the life? (This one is already taken)" rows="3"></textarea>
                        </div>
                    </div>
                    ...
                    <?php
                        if(isset($_POST['cButton'])){
                            ...
                            echo "<b>Question:</b>{$_POST['cQuestion']}<br/>";
                        }
                    ?>
                  </form>
            </div>
